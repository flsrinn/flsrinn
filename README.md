...
- **SK AI Leader Academy(SKALA) AI 3기** <sub><sup>2026.01 ~ 2026.06</sup></sub> <br>
  `SK주식회사 AX 주관 AI 서비스 개발 교육 수료` <br>
  `Agentic AI 기반 통합 테스트 자동화 시스템 QApilot 개발 - 최우수상(1위) 수상` <br><br>

- **컴퓨터공학부 조교(TA), 2025년 2학기** <sub><sup>2025.09 ~ 2025.12</sup></sub> <br>
  `웹프로그래밍기초 과목 실습 수업 보조` <br>
  `HTML, CSS, JavaScript 질의응답` <br><br>
...
- **코딩라운지 튜터, 2024년 2학기** <sub><sup>2024.09 ~ 2024.12</sup></sub> <br>
  `컴퓨터공학부 전공과목 질의응답` <br><br>

- **학부 연구생** <sub><sup>2024.01 ~ 2025.12</sup></sub> <br>
  `EcosmeticBin AIoT 시스템, QuickQuick 메모 시스템, VideoSummary 영상 요약 시스템 구현` <br>
  `컴퓨터 스크린 실시간 전송 실험적 성능 평가 연구 주도 및 제1저자 논문 게재`
...
#### [[🔗](https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE12567212)] 하이라이트와 스토리를 통합적으로 고려한 영상 요약 기법 <sub><sup>2025.11</sup></sub>
...
<details>
  <summary>[2025.12.31] 로컬 네트워크 기반의 화면 공유 장치 및 방법</summary>
...
![footer](https://capsule-render.vercel.app/api?type=waving&height=150&color=gradient&customColorList=12&section=footer)
